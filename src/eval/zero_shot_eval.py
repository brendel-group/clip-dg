...
if __name__ == '__main__':
    ...
    parser.add_argument("-b", "--base_save_dir", type=str,
                        default='/is/cluster/fast/pmayilvahanan/clip_ood_part2/evals/', help='saving accuracies')
    ...
    parser.add_argument("-c", "--checkpoints_path", type=str,
                        default='/mnt/qb/work/bethge/gpachitariu37/open_clip/logs/'
                                'laion-subsampled_15m_style-balanced_0_5e-4_32/checkpoints/', help='model_name')
    ...
    paths_file_name = "paths_mpi.yaml"
