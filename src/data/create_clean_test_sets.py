...
def main(args):
    ...
    save_dir_root = '/is/cluster/fast/pmayilvahanan/datasets/clean_datasets/'
    precision_level = 0.98

    # get classifier roots and dataset names
    classifier_root = {}
    classifier_root['stylistic'] = '/is/cluster/fast/pmayilvahanan/clip_ood_part2/results/evi_baseline_13K_round3_stylistic_v_rest_ViT-L-14__laion2b_s32b_b82k_exp1/'
    classifier_root['natural'] = '/is/cluster/fast/pmayilvahanan/clip_ood_part2/results/13K_round3_ViT-L-14__laion2b_s32b_b82k_False_20240420_141053/'
    ...
    paths_file_path = "/is/cluster/fast/pmayilvahanan/clip_ood_part2/code/src/paths/paths_mpi.yaml"
