...
import torchvision
from torchvision.transforms import v2 as pt_transforms
...
def get_data_loader(
    ...
    if transform is None:
        transform = pt_transforms.Compose([
            pt_transforms.Resize(256),
            pt_transforms.CenterCrop(224),
            pt_transforms.ToImage(),
            pt_transforms.ToDtype(torch.float32, scale=True)
        ])
