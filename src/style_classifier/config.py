...
def get_args_train():
    ...
    parser.add_argument('--cluster', type=str, default='mpi')
    ...
    parser.add_argument("--data_root", type=str,
                        default="/mnt/qb/work/bethge/pmayilvahanan31/datasets/val_sketch_style/",
    ...
    parser.add_argument('--base_directory', type=str,
                        default="/is/cluster/fast/pmayilvahanan/clip_ood_part2/results/",
    ...
    paths_file_name = "paths_" + args.cluster + '.yaml'
...
def get_args_eval():
    ...
    # input args
    parser.add_argument("--name", type=str, default='IN_S__jsd_0500e-7')
    parser.add_argument("--directory", type=str,
                        default="/mnt/qb/work/bethge/pmayilvahanan31/clip_ood/results/cnn/")
